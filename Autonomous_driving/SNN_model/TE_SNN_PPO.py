...
from .TE_SNN_Policy import RecurrentActorCriticPolicy
from stable_baselines3.common.type_aliases import GymEnv, MaybeCallback, Schedule
from stable_baselines3.common.utils import explained_variance, get_schedule_fn, obs_as_tensor, safe_mean
from stable_baselines3.common.vec_env import VecEnv
from .snn_buffer import RecurrentDictRolloutBuffer, RecurrentRolloutBuffer
...
class RecurrentPPO(OnPolicyAlgorithm):
    ...
    :param policy: The policy log to use (MlpPolicy, CnnPolicy, ...)
    ...
    def _setup_model(self) -> None:
        ...
        self._last_lstm_states = RNNStates(
            (
                ...
                th.zeros(single_hidden_state_shape, device=self.device),
                th.zeros(single_hidden_state_shape, device=self.device),
                th.zeros(single_hidden_state_shape, device=self.device)[...,0, np.newaxis],
            ),
            (
                th.zeros(single_hidden_state_shape, device=self.device),
                th.zeros(single_hidden_state_shape, device=self.device),
    ...
    def collect_rollouts(
        ...
        The term rollout here refers to the log-free notion and should not
        be used with the concept of rollout used in log-based RL or planning.
        ...
        while n_steps < n_rollout_steps:
            ...
            #print('policysteps',self.num_timesteps)
                ...
                if (
                    ...
                    with th.no_grad():
                        terminal_lstm_state = (
                            ...
                            lstm_states.vf[2][:, idx: idx + 1, :].contiguous(),
                            lstm_states.vf[3][:, idx: idx + 1, :].contiguous(),
                        )
