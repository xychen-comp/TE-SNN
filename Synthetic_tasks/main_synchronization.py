...
if __name__ == "__main__":
    ...
    snn_ckp_dir = os.path.join(home_dir, 'exp/Synchronization/checkpoint/')
    snn_rec_dir = os.path.join(home_dir, 'exp/Synchronization/record/')
