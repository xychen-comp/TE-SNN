...
parser.add_argument('--permute', default=False, action='store_true',
					help='True: PS-MNIST, False: Seq-MNIST')
parser.add_argument('--recurrent', default=False, action='store_true',
					help='Feedforward or recurrent')
parser.add_argument('--dropout', default=0.0, type=float, metavar='N',
					help='Dropout rate')
...
parser.add_argument('--fc', nargs= '+', default=[88,88,88], type=int, metavar='N',
...
parser.add_argument('--dt-lim', nargs= '+', default=[1e-1, 1e2], type=float, metavar='N',
					help='initialization of oscillation TE')
parser.add_argument('--name', default='', type=str,
					help='name to save the training model (default: none)')
