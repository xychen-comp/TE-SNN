...
from ppo_recurrent.RNN_Policy import RecurrentActorCriticPolicy
from ppo_recurrent.ppo_recurrent import RecurrentPPO
import torch
import numpy as np
import os
...
if __name__ == "__main__":
    main(model_name='LSTM',track = 'barcelona')