...
class BinaryActivation(nn.Module):
    ...
    def forward(self, x):
        return act_fun_adp(x, torch.tensor(self.threshold,device=x.device))
...
class RecurrentActorCriticPolicy(ActorCriticPolicy):
    ...
    def __init__(
        ...
        self.spiking_activation = BinaryActivation()
    ...
    def forward(
        ...
        # latent_pi = self.mlp_extractor.forward_actor(self.spiking_activation(latent_pi))
        # latent_vf = self.mlp_extractor.forward_critic(self.spiking_activation(latent_vf))
